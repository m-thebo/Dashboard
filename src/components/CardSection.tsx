...
const AIRecommendationCard = () => (
  <div className="w-full max-w-[390px] min-h-[220px]">
    ...
    >
      ...
      />
      {/* Card content */}
      <div className="relative z-10 flex flex-col gap-4 p-4 sm:p-6" style={{ fontFamily: 'Inter, sans-serif' }}>
        <h3 className="text-white text-[20px] sm:text-[22px] font-semibold text-center sm:text-left">AI Recommendations</h3>
        <p className="text-white text-sm leading-relaxed break-words max-w-full text-center sm:text-left"  style={{ opacity: 0.7 }}>
        ...
        <div className="flex-1 flex items-end justify-center sm:justify-start">
          <Button className="bg-white font-bold text-sm rounded-lg px-4 py-2.5 shadow-lg hover:bg-blue-50 transition-all duration-200 w-fit" style={{ fontFamily: 'Inter, sans-serif' }}>
...
const FeaturedCard1 = () => (
  <div className="w-full md:w-[320px] flex-1">
    <div
      className="relative rounded-2xl shadow-2xl overflow-hidden border h-full flex flex-col"
      style={{
        background: `
